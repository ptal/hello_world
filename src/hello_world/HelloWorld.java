...
public class HelloWorld {
  ...
  // Note that we use the `static` keyword because `enterGrades` is a function.
  // Later on, we will almost never use static functions again, and instead will only use methods on objects.
